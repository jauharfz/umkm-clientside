...
export default function PromoDiskon() {
    ...
    const handleUpdate = async (data) => {
        try {
            ...
            if (data.nilai  !== undefined) payload.nilai  = data.nilai;
            if (data.mulai  !== undefined) payload.mulai  = data.mulai;
            if (data.akhir  !== undefined) payload.akhir  = data.akhir;
            if (data.status !== undefined) payload.status = data.status;
            const res = await api.put(`/promo/${data.id}`, payload);
